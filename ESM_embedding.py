...
def ESM_embedding(ESM_model_name):
    ...
    torch.save(token_representations, rf'/home/xuyi/rotation1/ESM_embeddings/tokens/tokens_{ESM_model_name}.pt')
    torch.save(torch.tensor(sequence_length), rf'/home/xuyi/rotation1/ESM_embeddings/seq_length/seq_length_{ESM_model_name}.pt')
